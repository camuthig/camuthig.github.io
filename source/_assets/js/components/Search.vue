    ...
    <div class="flex flex-1 justify-end items-center text-right px-4">
        ...
        >
            ...
            <input
                ...
                v-model="query"
                ref="search"
                class="transition-fast relative block h-10 w-full lg:w-1/4 lg:focus:w-3/4 bg-grey-lightest border border-grey focus:border-blue-light outline-none cursor-pointer text-grey-darker px-4 pb-0"
